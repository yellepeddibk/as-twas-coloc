...
\end{center}
\begin{center}
\includegraphics[width=0.52\linewidth]{figures/qqplot_twas.png}
...
\vskip0.3em
\begin{center}
\includegraphics[width=0.58\linewidth]{figures/coloc_pp4_vs_pp3pp4.png}
...
\begin{center}
\includegraphics[width=0.88\linewidth,keepaspectratio]{figures/coloc_pp4_barplot.png}
