...
\begin{tikzpicture}[
  ...
  data/.style={rectangle, rounded corners=3pt, draw=ISUGold, fill=ISUGold!15,
               text width=10em, minimum height=1.8em, align=center,
               font=\footnotesize},
  arrow/.style={-{Stealth[length=2.5mm]}, thick, ISUDark}
]
  \node[data] (gwas) {AS GWAS (GCST005529)\\$N$=25,764};
  \node[data, right=2.0cm of gwas] (gtex) {GTEx v8 Mashr Models\\8 tissues};
  \node[box, below=0.42cm of $(gwas)!0.5!(gtex)$] (harm) {1. GWAS QC \& Harmonization};
...
\begin{itemize}\setlength{\itemsep}{2pt}
  \item Weighted protein interaction network of prioritized genes via Seq2Bind [1,2]
...
\begin{enumerate}\setlength{\itemsep}{0pt}\setlength{\parsep}{0pt}\setlength{\topsep}{0pt}\setlength{\leftskip}{-1.2em}
  ...
  \item Dey S, Chowdhury R. Twin Peaks. \textit{arXiv}:2509.22950. 2025.
...
\vskip0.5em
\begin{center}
\qrcode[height=5cm]{https://github.com/yellepeddibk/as-twas-coloc}\\[1em]
